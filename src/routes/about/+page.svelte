    ...
    const sections = [
        {
            ...
            paragraphs: [
                ...
                "I'm also interested in various technical areas, including: high-performance and parallel computing, probabilistic AI, LLMs, computer vision and robotics. I especially try to keep up with the state of the art and open source ecosystems for LLMs and other generative models.",
